...
slider_kp_pos.set(2.00)
slider_ki_pos.set(0.014)
slider_kd_pos.set(89.4)
...
slider_kp_vit.set(1.24)
slider_ki_vit.set(0.013)
slider_kd_vit.set(140.6)
...
slider_kp_inclin.set(1.01)
slider_ki_inclin.set(0.007)
slider_kd_inclin.set(85.3)
