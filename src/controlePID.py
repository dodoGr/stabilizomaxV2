...
slider_kp_pos.set(1.93)
slider_ki_pos.set(0.010)
slider_kd_pos.set(106.0)
...
slider_kp_vit.set(0.94)
slider_ki_vit.set(0.012)
slider_kd_vit.set(101.8)
...
slider_kp_inclin.set(1.15)
slider_ki_inclin.set(0.005)
